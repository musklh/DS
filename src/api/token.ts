...
export async function tokenCreate(body: API.TokenObtainPair, options?: { [key: string]: any }) {
...
export async function tokenRefreshCreate(body: API.TokenRefresh, options?: { [key: string]: any }) {
