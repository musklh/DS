    ...
    <el-card>
      ...
      <el-form :model="form" :rules="rules" ref="formRef" label-width="100px">
        <el-form-item label="病例号">
          ...
          <el-link @click="generateCaseId" type="primary" class="ml-2">自动生成</el-link>
        </el-form-item>
        ...
        <el-form-item label="身份证号" prop="idCard">
          ...
          <el-icon class="ml-2"><el-tooltip content="首次录入的身份证会自动创建患者资料"><i class="el-icon-info" /></el-tooltip></el-icon>
        </el-form-item>
