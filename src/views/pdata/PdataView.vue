    ...
    <div class="data-entry-workflow-container">
      <div class="workflow-header-steps">
        <el-steps :active="currentStep" finish-status="success" align-center>
          <el-step title="选择患者/病例" icon="UserFilled"></el-step>
          <el-step title="选择临床模板" icon="Tickets"></el-step>
          <el-step title="数据录入" icon="Edit"></el-step>
        </el-steps>
      </div>
      ...
      <div class="workflow-navigation-buttons" v-if="currentStep !== 2">
