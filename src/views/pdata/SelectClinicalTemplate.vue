<template>
      ...
      <el-card class="template-selection-card" shadow="never">
        ...
        <div class="template-content">
          ...
          <div style="text-align: center; margin-top: 30px;">
            <el-button type="primary" @click="selectTemplate" :disabled="!selectedRadioTemplate">
              选择模板
            </el-button>
          </div>
        </div>
  ...
  <script setup>
  import { ref } from 'vue';
  import { ElDivider, ElIcon, ElCard, ElAlert, ElButton, ElRadioGroup, ElRadio, ElMessage } from 'element-plus';
